...
class PE32_ConsolePerfTest extends com.puppetlabs.gatling.runner.SimulationWithScenario {

  val httpConf = httpConfig
      .baseURL("https://10.16.150.155:8140")
  ...
  val chain_2 =
    ...
    .exec(http("report")
          ...
          .headers(headers_108)
            .fileBody("PE32_PerfConsoleTest_request_108.txt")
      )
